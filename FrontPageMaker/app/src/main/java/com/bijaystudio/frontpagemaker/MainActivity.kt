...
class MainActivity : AppCompatActivity() {
    ...
    private var arrImageFilesCollege = arrayOf(R.drawable.college_temp_one_image , R.drawable.college_temp_two_image)
//    private var arrImageFilesSchool = arrayOf(R.drawable.college_temp_one_image)
